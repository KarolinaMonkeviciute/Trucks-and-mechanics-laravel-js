            ...
            <div class="col-md-9">
                <div class="card mt-5">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('trucks-index') }}"
                                                class="btn btn-secondary ms-2">Pradinis</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                                    ...
                                    <td>
                                        @if ($role->show('admin'))
                                            <a class="btn btn-success m-1"
                                                href={{ route('trucks-edit', $truck) }}>Redaguoti</a>
                                            <a class="btn btn-danger m-1"
                                                href={{ route('trucks-delete', $truck) }}>Nurašyti</a>
                                        @endif
                                        <a class="btn btn-secondary m-1"
                                            href={{ route('trucks-show', $truck) }}>Peržiūrėti</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                        ...
                        <div>
                            @if ($mechanicId)
                                <a href="{{ route('trucks-create', ['mechanic_id' => $mechanicId]) }}"
                                    class="btn btn-secondary">Pridėti</a>
                            @else
