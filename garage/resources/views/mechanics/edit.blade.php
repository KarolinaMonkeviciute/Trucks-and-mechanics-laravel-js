            ...
            <div class="col-md-5">
                <div class="card mt-5">
                    <div class="card-header">
                        <h1>Keisti mechaniko duomenis</h1>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('mechanics-update', $mechanic) }}" method="post" data-photo-edit
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="surname" class="form-control"
                                    value="{{ old('surname', $mechanic->surname) }}">
                                ...
                                @foreach ($mechanic->photos as $photo)
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <img src="{{ asset('img/' . $photo->path) }}" alt="photo"
                                                class="img-thumbnail ms-2" style="height: 50px;">
